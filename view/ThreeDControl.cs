...
namespace View3D.view
{
    ...
    public class ThreeDControl : GameWindow
    {
        ...
        private void DrawPrintbedFrame()
        {
            ...
            // CHANGED: BlendingFactorSrc / BlendingFactorDest are gone;
            // use BlendingFactor enum values directly (SrcAlpha / OneMinusSrcAlpha)
...
#if false
            // CHANGED: GL.Material(…, Color4) → GL.Materialfv(…, float[])
            GL.Materialfv(MaterialFace.FrontAndBack, MaterialParameter.AmbientAndDiffuse,
                new float[] { 0f, 0f, 0f, 180f / 255f });
            GL.Materialfv(MaterialFace.Front, MaterialParameter.Emission,
                new float[] { 0f, 0f, 0f, 0f });
            GL.Materialfv(MaterialFace.Front, MaterialParameter.Specular,
                new float[] { 0f, 0f, 0f, 1f });
            GL.Enable(EnableCap.LineSmooth);
            GL.Materialfv(MaterialFace.Front, MaterialParameter.Emission,
                new float[] { doorcol.R / 255f, doorcol.G / 255f, doorcol.B / 255f, doorcol.A / 255f });
            ...
            GL.Materialfv(MaterialFace.Front, MaterialParameter.Emission,
                new float[] { col.R / 255f, col.G / 255f, col.B / 255f, col.A / 255f });
